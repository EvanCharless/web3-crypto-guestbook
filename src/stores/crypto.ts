...
// Contract address get from 'Wae portal deployed to' when doing <npx hardhat run scripts/deploy.js --network mumbai>
const contractAddress = '0x8553ca9D0c0C44610C75Db1962C3a4824B135820'
